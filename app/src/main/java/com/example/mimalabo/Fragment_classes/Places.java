...
public class Places
{
    ...
    private Places(String names1, int ImagesId1, String description1)
    {
        this.names1 = names1;
    ...
    public static final Places places[]={
            ...
            "of the Guinean Library system. The BnGE was attached to the Ministry of Culture, but is currently a private department and as a National Library it is the center responsible for the preservation, " + "conservation and dissemination of the documentary " +
             ...
             "as an independent public institution of an administrative nature with a civil identity, with its own statutes and with financial autonomy that will depend organically on the Ministry of Culture."),
             ...
             "The Museum is currently expanding the collection and is working with young artists from across the region. It also aims to provide support and training for a new generation of artists, not only offering a space to exhibit, but also giving them the " +
              "opportunity to work with other institutions around the world."),
                    ...
                    " The trees and plants provide a refreshing experience. You can also go for short walks or jog around this park. If you are going to visit Equatorial Guinea, be sure to drop by the Malabo National Park to enjoy the beauty African nature."),
             ...
             " an important role in spreading the French language in Malabo - Equatorial Guinea. Inside this historical building is a large library for children full with french activities, cartoons and novel kids friendly novels, it also contains a library for adults , a big space for" +
              ...
              " spot that perfectly represents local architecture and culture. Most photographers regard this place as one of the best places for photography and sightseeing. If you are looking for an authentic Equatorial Guinea experience, the Catedral de Santa Isabel is the best place for you."),
             ...
             " shutters, and doors. Once home to the Portuguese Embassy, the building now holds several businesses. Recent renovations have restored its attractive interior and exterior"),
              ...
              " The dense and beautiful national park filled and rich with the most stunning and glorious species of wild animals would make you go crazy and excited. You can watch the gracious elephants, gorillas, chimpanzees, crocodiles, huge hippos and each of the giant" +
               " and stunning wild life creatures."),
              ...
              "Libertad (Bata) and La Paz (Malabo).This stadium will be one of the four venues of the Africa Cup of Nations 2015 to be held in Equatorial Guinea."),
             ...
             "interactive activities including workshops, recording, and other artistic expressions. Infrastructures in this center include libraries, cafeteria, offices, and training and rehearsal rooms. This place is a must-visit for lovers of the Equatorial Guinea culture!"),
              ...
              " the peak features a statue of the Virgin carrying baby Jesus on her back, in the style of African tribes.")
    };
}
