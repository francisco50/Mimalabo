...
//@Entity
public class Urban implements Parcelable
{
    ...
    public Urban(String itemId, String name, int ImagesId, String description)
    {
        if(itemId == null)
        {
    ...
    public static final Creator<Urban> CREATOR = new Creator<Urban>() {
        @Override
        public Urban createFromParcel(Parcel in) {
            return new Urban(in);
        }

        @Override
        public Urban[] newArray(int size) {
            return new Urban[size];
        }
    };
    ...
    public ContentValues toValues()
    {
        ...
        values.put(MalaboContract.COLUMN_DESCRIPTION3,description);
        values.put(MalaboContract.COLUMN_IMAGE3,ImageId);
        values.put(MalaboContract.COLUMN_NAME3,name);
        return values;
