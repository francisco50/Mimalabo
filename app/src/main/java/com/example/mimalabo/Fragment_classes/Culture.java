...
public class Culture
{
        ...
        public Culture(String name, int ImagesId, String description)
        {
        ...
        public static final Culture culture[]={
                ...
                "South of the river are the Okak Fang. Overall, the Fang are made up of 67 diverse clans. Besides Equatorial Guinea, the Fang people are also found in southern Cameroon as well as northern Gabon."),
                new Culture("Bubi Tribe",R.drawable.bubinew," They are found on the island of Bioko and are Bantus belonging to the “civilization of the ñame”. Their society is structured in the form" +
                        " of a kingdom that was maintained until the end of the colonial period. Their original religion was monotheist and music, dance and their traditional singing was inspired by religious ceremonies that are still deeply rooted. "),
                new Culture("Annobon Tribe",R.drawable.annobon,"Annobón, also called Pagalu, volcanic island in the South Atlantic Ocean near the Equator; it is part of Equatorial Guinea. " +
                        ...
                        " They are descended from enslaved Africans brought there by the Portuguese when the island was a dependency of Portugal’s São Tomé colony."),
                new Culture("Kombe Tribe",R.drawable.bujeba,"Kombe people are an African ethnic group, members of the Bantu group, who are indigenous to Equatorial Guinea.[1] They are native speakers of the Kombe language.\n" +
                        ...
                        "They later settled in Cameroon, south of Bata, and south of Rio Benito. They are sometimes referred to as Ndowe or \"Playeros\" (beach people in Spanish), one of several peoples on the Rio Muni coast."),
                new Culture("Ndowe Tribe",R.drawable.ndowe,"The Ndowe people form 3.6 of the population of Equatorial Guinea, They are a minority, formed by numerous ethnic groups: the Kombe," +
                        " the Bujeba, the Bapuka, the Balenke, the Enviko and the Benga. Their social organization is through a hierarchy of families, villages, lineages and clans. "),
                ...
                new Culture("Fernandinos and creoles Tribe",R.drawable.creoles,"The middle class of land owners and merchants, who lived a long time in the capital and were mixed descendants of workers " +
                        "that settled throughout the centuries on the plantations of the island of Bioko. "),
                new Culture("Pymies Tribe",R.drawable.pymies,"In Equatorial Guinea they are called Beyeles and Bokuigns. They live in small groups and are dedicated to hunting and to the collection of roots and wild berries."),
        };
